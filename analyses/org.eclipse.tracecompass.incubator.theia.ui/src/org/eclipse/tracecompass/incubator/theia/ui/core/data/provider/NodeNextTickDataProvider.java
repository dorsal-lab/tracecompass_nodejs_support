...
public class NodeNextTickDataProvider extends AbstractTreeDataProvider<TheiaStateSystemAnalysisModule, TmfTreeDataModel> implements ITmfTreeXYDataProvider<TmfTreeDataModel> {
	
	
	    public static final String ID = "org.eclipse.tracecompass.incubator.theia.ui.xy.nexttick.dataprovider"; //$NON-NLS-1$
	     ...
	     *            The analysis module
	     */
	    public NodeNextTickDataProvider(ITmfTrace trace, TheiaStateSystemAnalysisModule analysisModule) {
	    ...
	    public static @Nullable ITmfTreeDataProvider<? extends ITmfTreeDataModel> create(ITmfTrace trace) {
	        ...
	        return module != null ? new NodeNextTickDataProvider(trace, module) : null;
	    }
	    ...
	    protected TmfTreeModel<TmfTreeDataModel> getTree(ITmfStateSystem ss, Map<String, Object> fetchParameters, @Nullable IProgressMonitor monitor) throws StateSystemDisposedException {
	        ...
	        for (Integer quark : ss.getQuarks("THEIA","Metrics","NextTick","states")) { //$NON-NLS-1$ //$NON-NLS-2$
