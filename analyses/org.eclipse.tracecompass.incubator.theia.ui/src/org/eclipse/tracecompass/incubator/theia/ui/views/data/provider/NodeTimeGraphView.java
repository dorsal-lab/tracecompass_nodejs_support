...
import org.eclipse.tracecompass.incubator.theia.ui.core.data.provider.SpanLifeDataProvider;
...
public class NodeTimeGraphView extends BaseDataProviderTimeGraphView {
     ...
     * Default constructor
     */
    public NodeTimeGraphView() {
       super(ID, new BaseDataProviderTimeGraphPresentationProvider(), SpanLifeDataProvider.ID);
    }
