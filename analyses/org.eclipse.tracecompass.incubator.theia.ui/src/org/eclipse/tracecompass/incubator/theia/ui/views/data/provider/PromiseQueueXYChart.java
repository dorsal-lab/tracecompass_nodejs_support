...
import org.eclipse.tracecompass.incubator.theia.ui.core.data.provider.PromiseQueueDataProvider;
...
public class PromiseQueueXYChart extends TmfChartView{
	
	 /** View ID. */
   public static final String ID = "org.eclipse.tracecompass.incubator.theia.ui.views.promisequeue.dataprovider.xyview"; //$NON-NLS-1$

   /**
    * Constructor
    */
   public PromiseQueueXYChart() {
   ...
   protected TmfXYChartViewer createChartViewer(@Nullable Composite parent) {
       ...
       return new TmfFilteredXYChartViewer(parent, settings, PromiseQueueDataProvider.ID);
   }

   private static final class TreeXyViewer extends AbstractSelectTreeViewer2 {

       public TreeXyViewer(Composite parent) {
           super(parent, 1, PromiseQueueDataProvider.ID);
       }
